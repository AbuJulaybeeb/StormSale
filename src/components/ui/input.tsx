...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, variant = "default", ...props }, ref) => {
    const variantStyles = {
      default: "border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 dark:border-gray-600",
      success: "border-emerald-500 focus:ring-emerald-500 focus:border-emerald-500 dark:border-emerald-400",
      error: "border-red-500 focus:ring-red-500 focus:border-red-500 dark:border-red-400",
      warning: "border-yellow-500 focus:ring-yellow-500 focus:border-yellow-500 dark:border-yellow-400"
    }
