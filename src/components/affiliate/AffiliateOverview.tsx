...
export const AffiliateOverview = () => {
  const stats = [
    { title: 'Total Earnings', value: '$12,847', change: '+18%', icon: DollarSign },
  ...
  const recentPayouts = [
    { campaign: 'Tech Gadgets Pro', amount: '$1,250', date: '2 days ago', status: 'Completed' },
    { campaign: 'Web3 Masterclass', amount: '$890', date: '1 week ago', status: 'Completed' },
    { campaign: 'Crypto Tools', amount: '$2,150', date: '2 weeks ago', status: 'Completed' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Track your performance and maximize your earnings</p>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
              ...
              {recentPayouts.map((payout, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-emerald-600">{payout.amount}</div>
        ...
        <Card className="border-0 shadow-lg">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { tip: 'Optimize your content for higher conversions', impact: 'High' },
                { tip: 'Join trending campaigns early', impact: 'Medium' },
                { tip: 'Use multiple promotion channels', impact: 'High' },
                { tip: 'Engage with your audience regularly', impact: 'Medium' },
              ].map((item, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-emerald-50 dark:from-blue-900/20 dark:to-emerald-900/20 rounded-lg">
      ...
      <Card className="border-0 shadow-lg">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { label: 'Join New Campaign', description: 'Discover high-paying campaigns', icon: Users },
              { label: 'Track Performance', description: 'View analytics and insights', icon: TrendingUp },
              { label: 'Withdraw Earnings', description: 'Claim your commissions', icon: DollarSign },
            ].map((action, index) => {
