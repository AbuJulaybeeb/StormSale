        ...
        <CardHeader className="pb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <CardDescription>All data is encrypted before being stored on-chain</CardDescription>
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleLogSale}>
            <InputGroup className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-blue-50 dark:from-emerald-900/20 dark:to-blue-900/20 p-6 rounded-xl border border-emerald-200 dark:border-emerald-800">
